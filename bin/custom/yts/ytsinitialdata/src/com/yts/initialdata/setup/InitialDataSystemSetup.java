...
public class InitialDataSystemSetup extends AbstractSystemSetup {
    ...
    private void createCustomData(final SystemSetupContext context) {
        try {
            LOG.info("*****************************Import Custom Data************************");
            getSetupImpexService()
					.importImpexFile("/ytsinitialdata/import/custom/essentialdata-bands.impex", true);

            getSetupImpexService()
                    .importImpexFile("/ytsinitialdata/import/custom/projectdata-bandTour.impex", true);
